...
export type SceneData = {
  ...
  // How long this scene's own avatar clip actually is on screen (defaults
  // to AVATAR_CLIP_SECONDS for scenes generated by the original full-video
  // pipeline; an edit-screen scene regeneration can produce a clip up to 5s).
  avatarClipDurationSeconds?: number;
